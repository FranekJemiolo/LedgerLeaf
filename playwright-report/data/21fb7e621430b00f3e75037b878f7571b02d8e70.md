...
- Name: basic-smoke.spec.ts >> Basic Smoke Tests >> should have working navigation
- Location: tests/basic-smoke.spec.ts:16:3
  ...
  - main [ref=e10]:
    - generic [ref=e11]:
      ...
      - generic [ref=e32]:
        ...
        - paragraph [ref=e34]: Financial Clarity Achieved.
  - navigation [ref=e35]:
    - button "dashboard Dashboard" [ref=e36]:
      - generic [ref=e37]: dashboard
      - text: Dashboard
    - button "list_alt Inventory" [ref=e38]:
      - generic [ref=e39]: list_alt
      - text: Inventory
    - button "calendar_today Calendar" [ref=e40]:
      - generic [ref=e41]: calendar_today
      - text: Calendar
    - button "auto_awesome Wizard" [ref=e42]:
      - generic [ref=e43]: auto_awesome
      - text: Wizard
    - button "settings Settings" [ref=e44]:
