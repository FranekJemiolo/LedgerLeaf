...
- Name: basic-smoke.spec.ts >> Basic Smoke Tests >> should handle tab switching
- Location: tests/basic-smoke.spec.ts:75:3
...
Locator: locator('h2:has-text("Dashboard")')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('h2:has-text("Dashboard")')
